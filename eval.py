...
#from models.build_eaef import EAEF_EncoderDecoder as segmodel
...
class SegEvaluator(Evaluator):
    ...
    def compute_metric(self, results):
        ...
        result_line = print_iou(iou, freq_IoU, mean_pixel_acc, pixel_acc, config.class_names, show_no_back=False)
        return result_line


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('-e', '--epochs', default='D:/RGBX_Semantic_Segmentation/checkpoint/epoch-295.pth', type=str)
